...
import logo7 from '../images/profilepic.svg';
import logo8 from '../images/logo-8.svg';

const Navbar = () => {
    return (
        <header className="flex flex-col items-center border-b px-6 bg-white w-full py-2 space-y-4 md:space-y-0 md:flex-row md:justify-between">
            ...
            <div className="w-full md:w-auto mt-1 lg:ml-32 ">
                <select className=" py-2 pr-40   border bg-[#F7F7F8] border-[#EAEAEA] rounded w-full   my-3   " name="workspace" id="workspace">
